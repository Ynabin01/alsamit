...
<head>
    ...
    <title>Home - AI-Samit Manpower Pvt. Ltd.</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <!-- Favicons -->
    <link rel="shortcut icon" href="{{'/uploads/icons/' . $global_setting->favicon ?? '' }}" type="image/x-icon">
    <link rel="apple-touch-icon" href="{{'/uploads/icons/' . $global_setting->favicon ?? '' }}">
...
<body>
    ...
    <div id="top-bar" class="header-top hide-for-sticky nav-dark flex-has-center hide-for-medium" style="background-color: #e26a54!important; margin-bottom: -28px;" >
        <div class="flex-row container" style="padding-bottom: 7px;">
            <div class="flex-col hide-for-medium flex-left">   
            </div><!-- flex-col left -->
            <div class="flex-col hide-for-medium flex-right">
                <ul class="nav top-bar-nav nav-right nav-small  nav-pills">
                    <li class="html custom html_topbar_right">
                        <h4 style="color:white; margin-top: 19px;">Nepal Govt. Regd.No. 495/061/62</h4>
                    </li>
                </ul>
                <h4 style="color:white;     margin-top: -33px; margin-left: 519px;">Human Resource Development</h4>
                <ul class="social social-outline" style="margin-left: 1081px; margin-top: -42px;">
                ...
                <img src="/website/images/iso.png" style="    max-height: 42px; margin-left: 1014px; margin-top: -64px;">
                                        ...
                                        <div class="header__middle-center">
                                            <nav class="main-navigation text-center d-none d-lg-block">
                                                ...
                                                <li class="mainmenu__item menu-item-has-children">
                                                    ...
                                                    @if ($menu->nav_name == 'aboutus' || $menu->nav_name == 'gallery'|| $menu->nav_name == 'company')
                                                    <a href="#" class="mainmenu__link">{{ $menu->caption }}</a>
                                                    @else
                                                    <a href="/{{ $menu->nav_name }}" class="mainmenu__link">
                                                        <span data-hover="About Us" class="mm-text">{{ $menu->caption
                                                            }}</span>
                                                    </a>
                                                    @endif
                                                    ...
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li>
                                                            <a href="/{{ $menu->nav_name }}/{{ $submenu->nav_name }}">
                                                                <span data-hover="About Us" class="mm-text">{{
                                            ...
                                            <div class="site-info--wrapper d-none d-lg-block">
                                                <div class="site-info">
                                                    <div class="site-info__item">
                                                        <a href="tel:{{ $global_setting->phone }}"><strong>{{
                                                                $global_setting->phone }}</strong></a>
                                                        <a href="tel:{{ $global_setting->nepali_phone }}"></a>
                                                        {{-- <strong>{{ $global_setting->phone_ne }}</strong> --}}
                            ...
                            <div class="footer-widget">
                                ...
                                <div class="footer-widget">
                                    <ul class="footer-menu">
                                        ...
                                        <li><a href="tel:014418667">Phone No:{{ $global_setting->phone }}</a> <a
                                                href="tel:014430423">Contact:{{ $global_setting->phone_ne }}</a></li>
                                        <li><a href="mailto:{{ $global_setting->site_email }}">Email:{{
                                                $global_setting->site_email }}</a>
                                            <a href="mailto:{{ $global_setting->page_description }}">{{
                                                $global_setting->page_description }}</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <p class="copyright-text">&copy;
                                ...
                                AI-Samit Manpower Pvt. Ltd. All Rights Reserved. Developed by <a
                ...
                <nav class="offcanvas-navigation">
                    ...
                    <ul class="offcanvas-menu">
                        <li class="menu-item-has-children">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li>
                                    <a href="/{{ $menu->nav_name }}/{{ $submenu->nav_name }}">
                                        <span data-hover="About Us" class="mm-text">{{ $submenu->caption }}</span>
                                    </a>
                                </li>
                                @endforeach
                            </ul>
                    ...
                    <div class="site-info vertical">
                        <div class="site-info__item">
                            ...
                            <a href="mailto:{{ $global_setting->site_email }}">Email:{{ $global_setting->site_email
                                }}</a>
                        </div>
                    </div>
                </nav>
